...
function getDefaultSettings() {
    try {
        ...
        return {
            botName: mainSettings.botName || "🤖 DELTA MD 🔥",
            botOwner: mainSettings.botOwner || "𝕗𝕣𝕠𝕟𝕥𝕚𝕖𝕣",
            ...
            imageUrl: mainSettings.imageUrl || "https://i.ibb.co/ymnnfp45/ca7403d30072.jpg",
            ...
            packname: mainSettings.packname || "DELTA MD",
            author: mainSettings.author || "Malvin King",
            description: mainSettings.description || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ DELTA MD"
        };
    } catch (error) {
